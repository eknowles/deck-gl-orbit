 ...
 * @alpha
 */
export interface CorridorDisplayLayerProps extends CompositeLayerProps {
  data: CorridorArea[];
 ...
 * @alpha
 */
export default class CorridorDisplayLayer extends CompositeLayer<CorridorDisplayLayerProps> {
  static override layerName = "CorridorDisplayLayer";
